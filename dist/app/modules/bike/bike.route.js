...
router.put('/:bikeId', (0, auth_1.default)(user_constant_1.USER_ROLE.admin), multer_config_1.multerUpload.single("image"), bike_controller_1.bikeController.getUpdatedBike);
